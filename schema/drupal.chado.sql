...
--
-- Name: COLUMN analysis.program; Type: COMMENT; Schema: chado; Owner: -
--
...
--
-- Name: COLUMN analysis.programversion; Type: COMMENT; Schema: chado; Owner: -
--
...
--
-- Name: COLUMN analysis.algorithm; Type: COMMENT; Schema: chado; Owner: -
--
...
--
-- Name: COLUMN analysis.sourcename; Type: COMMENT; Schema: chado; Owner: -
--
...
--
-- Name: COLUMN analysis.sourceuri; Type: COMMENT; Schema: chado; Owner: -
--
...
--
-- Name: environmentprop_environmentprop_id_seq; Type: SEQUENCE OWNED BY; Schema: chado; Owner: -
--
...
--
-- Name: stockcollection_db_stockcollection_db_id_seq; Type: SEQUENCE OWNED BY; Schema: chado; Owner: -
--
...
--
-- Name: environmentprop_id; Type: DEFAULT; Schema: chado; Owner: -
--
...
--
-- Name: stockcollection_db_id; Type: DEFAULT; Schema: chado; Owner: -
--
...
--
-- Name: analysis_c1; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--
...
--
-- Name: analysis_organism_analysis_id_organism_id_key; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--

ALTER TABLE ONLY analysis_organism
    ADD CONSTRAINT analysis_organism_analysis_id_organism_id_key UNIQUE (analysis_id, organism_id);
...
--
-- Name: cv_name_key; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--
...
--
-- Name: cv_pkey; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--
...
--
-- Name: environmentprop_c1; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--

ALTER TABLE ONLY environmentprop
    ADD CONSTRAINT environmentprop_c1 UNIQUE (environment_id, type_id, rank);


--
-- Name: environmentprop_pkey; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--

ALTER TABLE ONLY environmentprop
    ADD CONSTRAINT environmentprop_pkey PRIMARY KEY (environmentprop_id);
...
--
-- Name: feature_stock_feature_id_stock_id_type_id_key; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--

ALTER TABLE ONLY feature_stock
    ADD CONSTRAINT feature_stock_feature_id_stock_id_type_id_key UNIQUE (feature_id, stock_id, type_id);
...
--
-- Name: featuremap_pub_featuremap_id_pub_id_key; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--

ALTER TABLE ONLY featuremap_pub
    ADD CONSTRAINT featuremap_pub_featuremap_id_pub_id_key UNIQUE (featuremap_id, pub_id);
...
--
-- Name: featurepos_featuremap_id_feature_id_map_feature_id_key; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--

ALTER TABLE ONLY featurepos
    ADD CONSTRAINT featurepos_featuremap_id_feature_id_map_feature_id_key UNIQUE (featuremap_id, feature_id, map_feature_id);
...
--
-- Name: featureposprop_featurepos_id_type_id_rank_key; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--

ALTER TABLE ONLY featureposprop
    ADD CONSTRAINT featureposprop_featurepos_id_type_id_rank_key UNIQUE (featurepos_id, type_id, rank);
...
--
-- Name: genotype_call_c1; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--

ALTER TABLE ONLY genotype_call
    ADD CONSTRAINT genotype_call_c1 UNIQUE (project_id, stock_id, feature_id, genotype_id);
...
--
-- Name: nd_experiment_contact_nd_experiment_id_contact_id_key; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--

ALTER TABLE ONLY nd_experiment_contact
    ADD CONSTRAINT nd_experiment_contact_nd_experiment_id_contact_id_key UNIQUE (nd_experiment_id, contact_id);
...
--
-- Name: nd_experiment_dbxref_nd_experiment_id_dbxref_id_key; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--

ALTER TABLE ONLY nd_experiment_dbxref
    ADD CONSTRAINT nd_experiment_dbxref_nd_experiment_id_dbxref_id_key UNIQUE (nd_experiment_id, dbxref_id);
...
--
-- Name: nd_experiment_project_project_id_nd_experiment_id_key; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--

ALTER TABLE ONLY nd_experiment_project
    ADD CONSTRAINT nd_experiment_project_project_id_nd_experiment_id_key UNIQUE (project_id, nd_experiment_id);


--
-- Name: nd_experiment_protocol_nd_experiment_id_nd_protocol_id_key; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--

ALTER TABLE ONLY nd_experiment_protocol
    ADD CONSTRAINT nd_experiment_protocol_nd_experiment_id_nd_protocol_id_key UNIQUE (nd_experiment_id, nd_protocol_id);
...
--
-- Name: nd_experiment_stock_nd_experiment_id_stock_id_type_id_key; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--

ALTER TABLE ONLY nd_experiment_stock
    ADD CONSTRAINT nd_experiment_stock_nd_experiment_id_stock_id_type_id_key UNIQUE (nd_experiment_id, stock_id, type_id);
...
--
-- Name: organism_relationship_subject_organism_id_object_organism_i_key; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--

ALTER TABLE ONLY organism_relationship
    ADD CONSTRAINT organism_relationship_subject_organism_id_object_organism_i_key UNIQUE (subject_organism_id, object_organism_id, type_id);
...
--
-- Name: phenotype_call_c1; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--

ALTER TABLE ONLY phenotype_call
    ADD CONSTRAINT phenotype_call_c1 UNIQUE (project_id, stock_id, cvterm_id, nd_geolocation_id);
...
--
-- Name: stock_image_stock_id_eimage_id_key; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--

ALTER TABLE ONLY stock_image
    ADD CONSTRAINT stock_image_stock_id_eimage_id_key UNIQUE (stock_id, eimage_id);
...
--
-- Name: stock_relationship_cvterm_stock_relationship_id_cvterm_id_p_key; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--

ALTER TABLE ONLY stock_relationship_cvterm
    ADD CONSTRAINT stock_relationship_cvterm_stock_relationship_id_cvterm_id_p_key UNIQUE (stock_relationship_id, cvterm_id, pub_id);
...
--
-- Name: stockcollection_db_a_pkey; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--

ALTER TABLE ONLY stockcollection_db
    ADD CONSTRAINT stockcollection_db_a_pkey PRIMARY KEY (stockcollection_db_id);


--
-- Name: stockcollection_db_stockcollection_id_db_id_key; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--
...
--
-- Name: environmentprop_idx1; Type: INDEX; Schema: chado; Owner: -; Tablespace: 
--
...
--
-- Name: environmentprop_idx2; Type: INDEX; Schema: chado; Owner: -; Tablespace: 
--
...
--
-- Name: synonym_idx3; Type: INDEX; Schema: chado; Owner: -; Tablespace: 
--

CREATE INDEX synonym_idx3 ON synonym USING btree (name);
...
--
-- Name: analysis_organism_analysis_id_fkey; Type: FK CONSTRAINT; Schema: chado; Owner: -
--

ALTER TABLE ONLY analysis_organism
    ADD CONSTRAINT analysis_organism_analysis_id_fkey FOREIGN KEY (analysis_id) REFERENCES analysis(analysis_id) ON DELETE CASCADE;
...
--
-- Name: environmentprop_environment_id_fkey; Type: FK CONSTRAINT; Schema: chado; Owner: -
--

ALTER TABLE ONLY environmentprop
    ADD CONSTRAINT environmentprop_environment_id_fkey FOREIGN KEY (environment_id) REFERENCES environment(environment_id) ON DELETE CASCADE;


--
-- Name: environmentprop_type_id_fkey; Type: FK CONSTRAINT; Schema: chado; Owner: -
--

ALTER TABLE ONLY environmentprop
    ADD CONSTRAINT environmentprop_type_id_fkey FOREIGN KEY (type_id) REFERENCES cvterm(cvterm_id) ON DELETE CASCADE;
...
--
-- Name: stockcollection_db_db_id_fkey; Type: FK CONSTRAINT; Schema: chado; Owner: -
--
...
--
-- Name: stockcollection_db_stockcollection_id_fkey; Type: FK CONSTRAINT; Schema: chado; Owner: -
--
