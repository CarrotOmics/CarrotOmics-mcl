...
--
-- Name: bims_phenotype_pub_by_crop_organism(character varying, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION bims_phenotype_pub_by_crop_organism(crop character varying, perm integer) RETURNS record
    LANGUAGE plpgsql
    AS $$
DECLARE
  _tmp text := '';
BEGIN
  SELECT STRING_AGG('SELECT T1.num AS t_pm, T2.num AS t_trait FROM (SELECT COUNT(PC.phenotype_call_id) AS num FROM bims.bims_' || N.node_id || '_bims_chado_phenotype_call PC) AS T1, (SELECT COUNT(DISTINCT PC.cvterm_id) AS num FROM bims.bims_' || N.node_id || '_bims_chado_phenotype_call PC) AS T2', ' union all ') INTO _tmp
  FROM bims_node N 
    INNER JOIN bims_crop C on C.crop_id = N.crop_id
  WHERE N.type = 'PROGRAM' AND N.access = perm AND C.name = crop;
  SELECT CAST(SUM(A.t_pm) as integer) AS t_pm, CAST(SUM(A.t_trait) as integer) AS t_trait FROM (SELECT T1.num AS t_pm, T2.num AS t_trait FROM (SELECT COUNT(PC.phenotype_call_id) AS num FROM bims.bims_776_bims_chado_phenotype_call PC) AS T1, (SELECT COUNT(DISTINCT PC.cvterm_id) AS num FROM bims.bims_776_bims_chado_phenotype_call PC) AS T2 union all SELECT T1.num AS t_pm, T2.num AS t_trait FROM (SELECT COUNT(PC.phenotype_call_id) AS num FROM bims.bims_782_bims_chado_phenotype_call PC) AS T1, (SELECT COUNT(DISTINCT PC.cvterm_id) AS num FROM bims.bims_782_bims_chado_phenotype_call PC) AS T2 ) A;
END;
$$;
...
--
-- Name: get_bio_data_table(text, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION get_bio_data_table(table_name text, id integer) RETURNS text
    LANGUAGE plpgsql
    AS $$
DECLARE 
 t_bundle_id INTEGER;
BEGIN
  SELECT INTO t_bundle_id bundle_id
  FROM a_chado_bundle
  WHERE data_table = table_name;
    
  RETURN 'chado_bio_data_' + t_bundle_id;
END;
$$;


--
-- Name: get_bio_data_table1(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION get_bio_data_table1(id integer) RETURNS text
    LANGUAGE plpgsql
    AS $$
BEGIN
  RETURN id + 1;
...
--
-- Name: a_bio_data_4; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE a_bio_data_4 (
...
--
-- Name: a_bio_data_4_record_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE a_bio_data_4_record_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: a_bio_data_4_record_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE a_bio_data_4_record_id_seq OWNED BY a_bio_data_4.record_id;


--
-- Name: a_bio_data_5; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE a_bio_data_5 (
    entity_id integer NOT NULL,
    record_id integer NOT NULL
);
...
--
-- Name: a_chado_bundle; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE a_chado_bundle (
...
--
-- Name: bims_archive; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE bims_archive (
...
--
-- Name: bims_archive_archive_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE bims_archive_archive_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bims_archive_archive_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE bims_archive_archive_id_seq OWNED BY bims_archive.archive_id;


--
-- Name: bims_bdata; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE bims_bdata (
    bdata_id integer NOT NULL,
...
--
-- Name: bims_bdata_bdata_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE bims_bdata_bdata_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bims_bdata_bdata_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE bims_bdata_bdata_id_seq OWNED BY bims_bdata.bdata_id;


--
-- Name: bims_chado_cv; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE bims_chado_cv (
...
--
-- Name: bims_chado_project; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE bims_chado_project (
    type character varying(255) NOT NULL,
...
--
-- Name: bims_color; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE bims_color (
...
--
-- Name: bims_color_color_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE bims_color_color_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bims_color_color_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE bims_color_color_id_seq OWNED BY bims_color.color_id;
...
CREATE TABLE bims_crop (
    ...
    prop text,
    ploidy integer DEFAULT 2 NOT NULL
);
...
--
-- Name: bims_descriptor_match; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE bims_descriptor_match (
    descriptor_match_id integer NOT NULL,
    program_id integer NOT NULL,
    cvterm_id_base integer NOT NULL,
    cvterm_id integer NOT NULL
);


--
-- Name: bims_descriptor_match_descriptor_match_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE bims_descriptor_match_descriptor_match_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bims_descriptor_match_descriptor_match_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE bims_descriptor_match_descriptor_match_id_seq OWNED BY bims_descriptor_match.descriptor_match_id;


--
-- Name: bims_descriptor_rank; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE bims_descriptor_rank (
    cvterm_id integer NOT NULL,
...
--
-- Name: bims_environment; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE bims_environment (
...
--
-- Name: bims_environment_environment_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE bims_environment_environment_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bims_environment_environment_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE bims_environment_environment_id_seq OWNED BY bims_environment.environment_id;


--
-- Name: bims_event; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE bims_event (
...
--
-- Name: bims_imported_cv; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE bims_imported_cv (
    program_id integer NOT NULL,
    cv_id integer NOT NULL,
    cv_name character varying(255) NOT NULL,
...
--
-- Name: bims_imported_project; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE bims_imported_project (
    program_id integer NOT NULL,
    project_id integer NOT NULL,
    project_name character varying(255) NOT NULL,
    type character varying(255) NOT NULL,
...
--
-- Name: bims_info; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE bims_info (
...
--
-- Name: bims_info_info_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE bims_info_info_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bims_info_info_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE bims_info_info_id_seq OWNED BY bims_info.info_id;
...
--
-- Name: bims_mapping_accession; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE bims_mapping_accession (
    program_id integer NOT NULL,
    chado_stock_id integer NOT NULL,
    bims_stock_id integer NOT NULL,
    prop text
);


--
-- Name: bims_mapping_feature; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE bims_mapping_feature (
    program_id integer NOT NULL,
    chado_feature_id integer NOT NULL,
    bims_feature_id integer NOT NULL,
    prop text
);


--
-- Name: bims_marker_location; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE bims_marker_location (
    feature_id integer NOT NULL,
    ss_id character varying(500),
    analysis_id integer,
    genome character varying(500),
    chromosome_fid integer,
    chromosome character varying(500),
    loc_start character varying(255),
    loc_stop character varying(255),
    prop text,
    marker character varying(500) NOT NULL
);
...
CREATE TABLE bims_mview_descriptor (
    ...
    prop text,
    definition text,
    chado integer DEFAULT 0 NOT NULL,
    program_id integer
);
...
CREATE TABLE bims_node (
    ...
    project_sub_type character varying(255)
);
...
--
-- Name: bims_resource; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE bims_resource (
...
--
-- Name: bims_resource_resource_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE bims_resource_resource_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bims_resource_resource_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE bims_resource_resource_id_seq OWNED BY bims_resource.resource_id;


--
-- Name: bims_site; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE bims_site (
...
--
-- Name: bims_site_site_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE bims_site_site_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bims_site_site_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE bims_site_site_id_seq OWNED BY bims_site.site_id;


--
-- Name: bims_term; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE bims_term (
...
--
-- Name: bims_term_term_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE bims_term_term_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bims_term_term_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE bims_term_term_id_seq OWNED BY bims_term.term_id;


--
-- Name: bims_tool; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE bims_tool (
...
--
-- Name: bims_tool_tool_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE bims_tool_tool_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bims_tool_tool_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE bims_tool_tool_id_seq OWNED BY bims_tool.tool_id;
...
--
-- Name: bims_variable; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE bims_variable (
    name character varying(255) NOT NULL,
    value text,
    create_date timestamp without time zone NOT NULL,
...
--
-- Name: ckeditor_input_format; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE ckeditor_input_format (
    name character varying(128) DEFAULT ''::character varying NOT NULL,
    format character varying(128) DEFAULT ''::character varying NOT NULL
);


--
-- Name: TABLE ckeditor_input_format; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE ckeditor_input_format IS 'Stores CKEditor input format assignments';


--
-- Name: COLUMN ckeditor_input_format.name; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN ckeditor_input_format.name IS 'Name of the CKEditor role';


--
-- Name: COLUMN ckeditor_input_format.format; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN ckeditor_input_format.format IS 'Drupal filter format ID';


--
-- Name: ckeditor_settings; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: TABLE ckeditor_settings; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE ckeditor_settings IS 'Stores CKEditor profile settings';


--
-- Name: COLUMN ckeditor_settings.name; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN ckeditor_settings.name IS 'Name of the CKEditor profile';


--
-- Name: COLUMN ckeditor_settings.settings; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN ckeditor_settings.settings IS 'Profile settings';
...
--
-- Name: do_count; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE do_count (
...
--
-- Name: do_count_count_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE do_count_count_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: do_count_count_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE do_count_count_id_seq OWNED BY do_count.count_id;


--
-- Name: do_count_type; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE do_count_type (
...
--
-- Name: do_count_type_count_type_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE do_count_type_count_type_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: do_count_type_count_type_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE do_count_type_count_type_id_seq OWNED BY do_count_type.count_type_id;
...
--
-- Name: field_group; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
CREATE TABLE field_group (
    ...
    entity_type character varying(32) DEFAULT ''::character varying NOT NULL,
    bundle character varying(128) DEFAULT ''::character varying NOT NULL,
    mode character varying(128) DEFAULT ''::character varying NOT NULL,
    parent_name character varying(32) DEFAULT ''::character varying NOT NULL,
    data bytea NOT NULL
);


--
-- Name: TABLE field_group; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE field_group IS 'Table that contains field group entries and settings.';


--
-- Name: COLUMN field_group.id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN field_group.id IS 'The primary identifier for a group';


--
-- Name: COLUMN field_group.identifier; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN field_group.identifier IS 'The unique string identifier for a group.';


--
-- Name: COLUMN field_group.group_name; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN field_group.group_name IS 'The name of this group.';


--
-- Name: COLUMN field_group.parent_name; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN field_group.parent_name IS 'The parent name for a group';


--
-- Name: COLUMN field_group.data; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN field_group.data IS 'Serialized data containing the group properties that do not warrant a dedicated column.';
...
CREATE SEQUENCE field_group_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: field_group_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE field_group_id_seq OWNED BY field_group.id;
...
--
-- Name: gensas_exempt; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE gensas_exempt (
    exempt_id integer NOT NULL,
...
--
-- Name: gensas_exempt_exempt_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE gensas_exempt_exempt_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: gensas_exempt_exempt_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE gensas_exempt_exempt_id_seq OWNED BY gensas_exempt.exempt_id;
...
--
-- Name: gensas_job_relationship; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE gensas_job_relationship (
    parent_id character varying(200) NOT NULL,
    child_id character varying(200) NOT NULL,
    type character varying(200)
);
...
--
-- Name: gensas_project_job_log; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE gensas_project_job_log (
    log_id integer NOT NULL,
    project_id character varying(200),
...
--
-- Name: gensas_project_job_log_log_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE gensas_project_job_log_log_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: gensas_project_job_log_log_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE gensas_project_job_log_log_id_seq OWNED BY gensas_project_job_log.log_id;
...
--
-- Name: gensas_report; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE gensas_report (
...
--
-- Name: gensas_report_report_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE gensas_report_report_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: gensas_report_report_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE gensas_report_report_id_seq OWNED BY gensas_report.report_id;
...
--
-- Name: gensas_seq_group_job; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE gensas_seq_group_job (
    seq_group_id integer NOT NULL,
    job_id character varying(200) NOT NULL
);
...
CREATE TABLE gensas_tool (
    ...
    ncbi_submit integer DEFAULT 0,
    soft_mask integer DEFAULT 0
);
...
CREATE TABLE gensas_tool_param (
    ...
    param_multi integer DEFAULT 0 NOT NULL
);
...
--
-- Name: mbt_ballot; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE mbt_ballot (
    ballot_id integer NOT NULL,
    name character varying(255) NOT NULL,
    event_id integer NOT NULL,
    title character varying(255) NOT NULL,
    title_notes character varying(255),
    header text,
    content text,
    notes text,
    footer text,
    ...
    prop text,
    num_vote integer DEFAULT 0 NOT NULL,
    orderby character varying(255),
    custom_header text,
    table_width integer DEFAULT 100 NOT NULL
);


--
-- Name: mbt_ballot_ballot_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE mbt_ballot_ballot_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: mbt_ballot_ballot_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE mbt_ballot_ballot_id_seq OWNED BY mbt_ballot.ballot_id;


--
-- Name: mbt_candidate; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE mbt_candidate (
...
--
-- Name: mbt_candidate_candidate_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE mbt_candidate_candidate_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: mbt_candidate_candidate_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE mbt_candidate_candidate_id_seq OWNED BY mbt_candidate.candidate_id;


--
-- Name: mbt_event; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE mbt_event (
    event_id integer NOT NULL,
    title character varying(255) NOT NULL,
    header text,
    footer text,
    ...
    status integer DEFAULT 0 NOT NULL,
    vote_perm text,
    file_dir character varying(500),
...
--
-- Name: mbt_event_event_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE mbt_event_event_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: mbt_event_event_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE mbt_event_event_id_seq OWNED BY mbt_event.event_id;


--
-- Name: mbt_vote; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE mbt_vote (
...
--
-- Name: mbt_vote_vote_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE mbt_vote_vote_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: mbt_vote_vote_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE mbt_vote_vote_id_seq OWNED BY mbt_vote.vote_id;


--
-- Name: mcl_data_group; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE mcl_data_group (
...
--
-- Name: mcl_data_group_data_group_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE mcl_data_group_data_group_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: mcl_data_group_data_group_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE mcl_data_group_data_group_id_seq OWNED BY mcl_data_group.data_group_id;


--
-- Name: mcl_data_group_member; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE mcl_data_group_member (
    data_group_member_id integer NOT NULL,
    data_group_id integer NOT NULL,
    type character varying(255) NOT NULL,
...
--
-- Name: mcl_data_group_member_data_group_member_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE mcl_data_group_member_data_group_member_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: mcl_data_group_member_data_group_member_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE mcl_data_group_member_data_group_member_id_seq OWNED BY mcl_data_group_member.data_group_member_id;
...
--
-- Name: mcl_dummy_var; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE mcl_dummy_var (
    dummy_var_id integer NOT NULL,
    name character varying(255) NOT NULL,
    id integer,
    description text
);
...
--
-- Name: mcl_dummy_var_dummy_var_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE mcl_dummy_var_dummy_var_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: mcl_dummy_var_dummy_var_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE mcl_dummy_var_dummy_var_id_seq OWNED BY mcl_dummy_var.dummy_var_id;
...
--
-- Name: mcl_site_var; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE mcl_site_var (
    site_var_id integer NOT NULL,
    name character varying(255) NOT NULL,
...
--
-- Name: mcl_site_var_site_var_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE mcl_site_var_site_var_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: mcl_site_var_site_var_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE mcl_site_var_site_var_id_seq OWNED BY mcl_site_var.site_var_id;
...
CREATE TABLE mdlu_database (
    ...
    profile_num integer DEFAULT 0 NOT NULL,
    description text,
...
--
-- Name: mdlu_version; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE mdlu_version (
...
--
-- Name: mdlu_version_version_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE mdlu_version_version_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: mdlu_version_version_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE mdlu_version_version_id_seq OWNED BY mdlu_version.version_id;
...
--
-- Name: simple_content_type_data; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE simple_content_type_data (
    nid bigint NOT NULL,
    uid bigint NOT NULL,
    simple_content_type_textfield character varying(255) NOT NULL,
    simple_content_type_textarea text NOT NULL,
    simple_content_type_text text NOT NULL,
    simple_content_type_format character varying(255) NOT NULL,
    CONSTRAINT simple_content_type_data_nid_check CHECK ((nid >= 0)),
    CONSTRAINT simple_content_type_data_uid_check CHECK ((uid >= 0))
);


--
-- Name: TABLE simple_content_type_data; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE simple_content_type_data IS 'Stores information for our example content type.';


--
-- Name: COLUMN simple_content_type_data.nid; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN simple_content_type_data.nid IS 'The node.nid of the node being created.';


--
-- Name: COLUMN simple_content_type_data.uid; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN simple_content_type_data.uid IS 'The user.uid of the user this node belongs to.';


--
-- Name: COLUMN simple_content_type_data.simple_content_type_textfield; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN simple_content_type_data.simple_content_type_textfield IS 'The value entered into the text field.';


--
-- Name: COLUMN simple_content_type_data.simple_content_type_textarea; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN simple_content_type_data.simple_content_type_textarea IS 'The value for our textarea without formats.';


--
-- Name: COLUMN simple_content_type_data.simple_content_type_text; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN simple_content_type_data.simple_content_type_text IS 'The value for our textarea with formats.';


--
-- Name: COLUMN simple_content_type_data.simple_content_type_format; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN simple_content_type_data.simple_content_type_format IS 'The format for our textarea with formats.';
...
--
-- Name: t_chado_bundle_bundle_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE t_chado_bundle_bundle_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: t_chado_bundle_bundle_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE t_chado_bundle_bundle_id_seq OWNED BY a_chado_bundle.bundle_id;
...
--
-- Name: wysiwyg; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE wysiwyg (
    format character varying(255) NOT NULL,
    editor character varying(128) DEFAULT ''::character varying NOT NULL,
    settings text
);


--
-- Name: TABLE wysiwyg; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE wysiwyg IS 'Stores Wysiwyg profiles.';


--
-- Name: COLUMN wysiwyg.format; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN wysiwyg.format IS 'The filter_format.format of the text format.';


--
-- Name: COLUMN wysiwyg.editor; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN wysiwyg.editor IS 'Internal name of the editor attached to the text format.';


--
-- Name: COLUMN wysiwyg.settings; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN wysiwyg.settings IS 'Configuration settings for the editor.';


--
-- Name: wysiwyg_user; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
CREATE TABLE wysiwyg_user (
    ...
    format character varying(255) NOT NULL,
    status integer DEFAULT 0 NOT NULL,
    CONSTRAINT wysiwyg_user_status_check CHECK ((status >= 0)),
    CONSTRAINT wysiwyg_user_uid_check CHECK ((uid >= 0))
);


--
-- Name: TABLE wysiwyg_user; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE wysiwyg_user IS 'Stores user preferences for wysiwyg profiles.';


--
-- Name: COLUMN wysiwyg_user.uid; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN wysiwyg_user.uid IS 'The users.uid of the user.';


--
-- Name: COLUMN wysiwyg_user.format; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN wysiwyg_user.format IS 'The filter_format.format of the text format.';


--
-- Name: COLUMN wysiwyg_user.status; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN wysiwyg_user.status IS 'Boolean indicating whether the format is enabled by default.';


--
-- Name: bundle_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY a_chado_bundle ALTER COLUMN bundle_id SET DEFAULT nextval('t_chado_bundle_bundle_id_seq'::regclass);
...
--
-- Name: archive_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY bims_archive ALTER COLUMN archive_id SET DEFAULT nextval('bims_archive_archive_id_seq'::regclass);


--
-- Name: bdata_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY bims_bdata ALTER COLUMN bdata_id SET DEFAULT nextval('bims_bdata_bdata_id_seq'::regclass);


--
-- Name: color_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY bims_color ALTER COLUMN color_id SET DEFAULT nextval('bims_color_color_id_seq'::regclass);
...
--
-- Name: descriptor_match_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY bims_descriptor_match ALTER COLUMN descriptor_match_id SET DEFAULT nextval('bims_descriptor_match_descriptor_match_id_seq'::regclass);
...
ALTER TABLE ONLY bims_environment ALTER COLUMN environment_id SET DEFAULT nextval('bims_environment_environment_id_seq'::regclass);
...
--
-- Name: info_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY bims_info ALTER COLUMN info_id SET DEFAULT nextval('bims_info_info_id_seq'::regclass);
...
ALTER TABLE ONLY bims_resource ALTER COLUMN resource_id SET DEFAULT nextval('bims_resource_resource_id_seq'::regclass);
...
ALTER TABLE ONLY bims_site ALTER COLUMN site_id SET DEFAULT nextval('bims_site_site_id_seq'::regclass);
...
ALTER TABLE ONLY bims_term ALTER COLUMN term_id SET DEFAULT nextval('bims_term_term_id_seq'::regclass);
...
ALTER TABLE ONLY bims_tool ALTER COLUMN tool_id SET DEFAULT nextval('bims_tool_tool_id_seq'::regclass);
...
ALTER TABLE ONLY do_count ALTER COLUMN count_id SET DEFAULT nextval('do_count_count_id_seq'::regclass);


--
-- Name: count_type_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY do_count_type ALTER COLUMN count_type_id SET DEFAULT nextval('do_count_type_count_type_id_seq'::regclass);
...
ALTER TABLE ONLY field_group ALTER COLUMN id SET DEFAULT nextval('field_group_id_seq'::regclass);
...
--
-- Name: exempt_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY gensas_exempt ALTER COLUMN exempt_id SET DEFAULT nextval('gensas_exempt_exempt_id_seq'::regclass);
...
ALTER TABLE ONLY gensas_project_job_log ALTER COLUMN log_id SET DEFAULT nextval('gensas_project_job_log_log_id_seq'::regclass);
...
ALTER TABLE ONLY gensas_report ALTER COLUMN report_id SET DEFAULT nextval('gensas_report_report_id_seq'::regclass);
...
--
-- Name: ballot_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY mbt_ballot ALTER COLUMN ballot_id SET DEFAULT nextval('mbt_ballot_ballot_id_seq'::regclass);


--
-- Name: candidate_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY mbt_candidate ALTER COLUMN candidate_id SET DEFAULT nextval('mbt_candidate_candidate_id_seq'::regclass);
...
ALTER TABLE ONLY mbt_event ALTER COLUMN event_id SET DEFAULT nextval('mbt_event_event_id_seq'::regclass);
...
ALTER TABLE ONLY mbt_vote ALTER COLUMN vote_id SET DEFAULT nextval('mbt_vote_vote_id_seq'::regclass);


--
-- Name: data_group_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY mcl_data_group ALTER COLUMN data_group_id SET DEFAULT nextval('mcl_data_group_data_group_id_seq'::regclass);


--
-- Name: data_group_member_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY mcl_data_group_member ALTER COLUMN data_group_member_id SET DEFAULT nextval('mcl_data_group_member_data_group_member_id_seq'::regclass);
...
--
-- Name: dummy_var_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY mcl_dummy_var ALTER COLUMN dummy_var_id SET DEFAULT nextval('mcl_dummy_var_dummy_var_id_seq'::regclass);
...
--
-- Name: site_var_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY mcl_site_var ALTER COLUMN site_var_id SET DEFAULT nextval('mcl_site_var_site_var_id_seq'::regclass);
...
ALTER TABLE ONLY mdlu_version ALTER COLUMN version_id SET DEFAULT nextval('mdlu_version_version_id_seq'::regclass);
...
--
-- Name: bims_archive_bims_archive_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_archive
    ADD CONSTRAINT bims_archive_bims_archive_ukey_001_key UNIQUE (program_id, user_id, submit_date);


--
-- Name: bims_archive_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_archive
    ADD CONSTRAINT bims_archive_pkey PRIMARY KEY (archive_id);


--
-- Name: bims_archive_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_archive
    ADD CONSTRAINT bims_archive_ukey_001_key UNIQUE (name);


--
-- Name: bims_bdata_bims_bdata_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_bdata
    ADD CONSTRAINT bims_bdata_bims_bdata_ukey_001_key UNIQUE (crop_id, name, user_id);


--
-- Name: bims_bdata_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_bdata
    ADD CONSTRAINT bims_bdata_pkey PRIMARY KEY (bdata_id);


--
-- Name: bims_bdata_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_bdata
    ADD CONSTRAINT bims_bdata_ukey_001_key UNIQUE (crop_id, name);


--
-- Name: bims_chado_cv_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_chado_cv
    ADD CONSTRAINT bims_chado_cv_pkey PRIMARY KEY (cv_id);


--
-- Name: bims_chado_cv_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_chado_cv
    ADD CONSTRAINT bims_chado_cv_ukey_001_key UNIQUE (cv_name);


--
-- Name: bims_chado_project_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_chado_project
    ADD CONSTRAINT bims_chado_project_ukey_001_key UNIQUE (project_id);


--
-- Name: bims_color_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_color
    ADD CONSTRAINT bims_color_pkey PRIMARY KEY (color_id);


--
-- Name: bims_color_ukey_bims_color_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_color
    ADD CONSTRAINT bims_color_ukey_bims_color_001_key UNIQUE (type, code);
...
--
-- Name: bims_crop_ukey_bims_crop_name_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_crop
    ADD CONSTRAINT bims_crop_ukey_bims_crop_name_key UNIQUE (name);


--
-- Name: bims_descriptor_match_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_descriptor_match
    ADD CONSTRAINT bims_descriptor_match_ukey_001_key UNIQUE (program_id, cvterm_id_base, cvterm_id);


--
-- Name: bims_descriptor_rank_bims_descriptor_rank_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_descriptor_rank
    ADD CONSTRAINT bims_descriptor_rank_bims_descriptor_rank_ukey_001_key UNIQUE (program_id, cvterm_id);


--
-- Name: bims_descriptor_rank_bims_descriptor_rank_ukey_001_key_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_descriptor_rank
    ADD CONSTRAINT bims_descriptor_rank_bims_descriptor_rank_ukey_001_key_key UNIQUE (program_id, cvterm_id);


--
-- Name: bims_descriptor_rank_ukey_bims_descriptor_rank_cvterm_id_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_descriptor_rank
    ADD CONSTRAINT bims_descriptor_rank_ukey_bims_descriptor_rank_cvterm_id_key UNIQUE (cvterm_id);


--
-- Name: bims_environment_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_environment
    ADD CONSTRAINT bims_environment_pkey PRIMARY KEY (environment_id);


--
-- Name: bims_environment_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_environment
    ADD CONSTRAINT bims_environment_ukey_001_key UNIQUE (bdata_id, name);
...
--
-- Name: bims_imported_cv_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_imported_cv
    ADD CONSTRAINT bims_imported_cv_ukey_001_key UNIQUE (program_id, cv_id);


--
-- Name: bims_imported_project_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_imported_project
    ADD CONSTRAINT bims_imported_project_ukey_001_key UNIQUE (program_id, project_id);


--
-- Name: bims_info_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_info
    ADD CONSTRAINT bims_info_pkey PRIMARY KEY (info_id);


--
-- Name: bims_info_ukey_bims_info_name_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_info
    ADD CONSTRAINT bims_info_ukey_bims_info_name_key UNIQUE (name);
...
--
-- Name: bims_list_ukey_bims_list_name_type_program_id_user_id_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_list
    ADD CONSTRAINT bims_list_ukey_bims_list_name_type_program_id_user_id_key UNIQUE (name, type, program_id, user_id);


--
-- Name: bims_mapping_accession_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_mapping_accession
    ADD CONSTRAINT bims_mapping_accession_ukey_001_key UNIQUE (program_id, chado_stock_id, bims_stock_id);


--
-- Name: bims_mapping_feature_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_mapping_feature
    ADD CONSTRAINT bims_mapping_feature_ukey_001_key UNIQUE (program_id, chado_feature_id, bims_feature_id);


--
-- Name: bims_marker_location_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_marker_location
    ADD CONSTRAINT bims_marker_location_ukey_001_key UNIQUE (feature_id);


--
-- Name: bims_mview_cross_stats_ukey_bims_mview_cross_stats_node_id_nd_e; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_mview_cross_stats
    ADD CONSTRAINT bims_mview_cross_stats_ukey_bims_mview_cross_stats_node_id_nd_e UNIQUE (node_id, nd_experiment_id, cvterm_id);


--
-- Name: bims_mview_descriptor_bims_mview_descriptor_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_mview_descriptor
    ADD CONSTRAINT bims_mview_descriptor_bims_mview_descriptor_ukey_001_key UNIQUE (program_id, cvterm_id);


--
-- Name: bims_mview_phenotype_stats_ukey_bims_mview_phenotype_stats_node; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_mview_phenotype_stats
    ADD CONSTRAINT bims_mview_phenotype_stats_ukey_bims_mview_phenotype_stats_node UNIQUE (node_id, cvterm_id);
...
--
-- Name: bims_node_ukey_bims_node_root_id_name_owner_id_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_node
    ADD CONSTRAINT bims_node_ukey_bims_node_root_id_name_owner_id_key UNIQUE (root_id, name, owner_id);
...
--
-- Name: bims_resource_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_resource
    ADD CONSTRAINT bims_resource_pkey PRIMARY KEY (resource_id);


--
-- Name: bims_resource_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_resource
    ADD CONSTRAINT bims_resource_ukey_001_key UNIQUE (name);


--
-- Name: bims_term_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_term
    ADD CONSTRAINT bims_term_pkey PRIMARY KEY (term_id);


--
-- Name: bims_term_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_term
    ADD CONSTRAINT bims_term_ukey_001_key UNIQUE (name);


--
-- Name: bims_tool_name_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_tool
    ADD CONSTRAINT bims_tool_name_key UNIQUE (name);


--
-- Name: bims_tool_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_tool
    ADD CONSTRAINT bims_tool_pkey PRIMARY KEY (tool_id);
...
--
-- Name: bims_variable_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY bims_variable
    ADD CONSTRAINT bims_variable_pkey PRIMARY KEY (name);
...
--
-- Name: ckeditor_input_format_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY ckeditor_input_format
    ADD CONSTRAINT ckeditor_input_format_pkey PRIMARY KEY (name, format);


--
-- Name: ckeditor_settings_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY ckeditor_settings
    ADD CONSTRAINT ckeditor_settings_pkey PRIMARY KEY (name);
...
--
-- Name: do_count_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY do_count
    ADD CONSTRAINT do_count_pkey PRIMARY KEY (count_id);


--
-- Name: do_count_type_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY do_count_type
    ADD CONSTRAINT do_count_type_pkey PRIMARY KEY (count_type_id);


--
-- Name: do_count_type_ukey_bims_count_type_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY do_count_type
    ADD CONSTRAINT do_count_type_ukey_bims_count_type_001_key UNIQUE (name);
...
--
-- Name: field_group_identifier_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY field_group
    ADD CONSTRAINT field_group_identifier_key UNIQUE (identifier);


--
-- Name: field_group_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: gensas_exempt_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY gensas_exempt
    ADD CONSTRAINT gensas_exempt_pkey PRIMARY KEY (exempt_id);


--
-- Name: gensas_exempt_ukey_gensas_exempt_type_id_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY gensas_exempt
    ADD CONSTRAINT gensas_exempt_ukey_gensas_exempt_type_id_key UNIQUE (type, id);
...
--
-- Name: gensas_job_relationship_ukey_gensas_job_relationship_parent_id_; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY gensas_job_relationship
    ADD CONSTRAINT gensas_job_relationship_ukey_gensas_job_relationship_parent_id_ UNIQUE (parent_id, child_id);
...
--
-- Name: gensas_project_job_log_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY gensas_project_job_log
    ADD CONSTRAINT gensas_project_job_log_pkey PRIMARY KEY (log_id);
...
--
-- Name: gensas_report_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY gensas_report
    ADD CONSTRAINT gensas_report_pkey PRIMARY KEY (report_id);
...
--
-- Name: gensas_seq_group_job_ukey_gensas_seq_group_seq_group_id_id_job_; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY gensas_seq_group_job
    ADD CONSTRAINT gensas_seq_group_job_ukey_gensas_seq_group_seq_group_id_id_job_ UNIQUE (seq_group_id, job_id);
...
--
-- Name: mbt_ballot_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mbt_ballot
    ADD CONSTRAINT mbt_ballot_pkey PRIMARY KEY (ballot_id);


--
-- Name: mbt_ballot_ukey_mbt_ballot_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mbt_ballot
    ADD CONSTRAINT mbt_ballot_ukey_mbt_ballot_001_key UNIQUE (name, event_id);


--
-- Name: mbt_candidate_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mbt_candidate
    ADD CONSTRAINT mbt_candidate_pkey PRIMARY KEY (candidate_id);


--
-- Name: mbt_candidate_ukey_mbt_candidate_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mbt_candidate
    ADD CONSTRAINT mbt_candidate_ukey_mbt_candidate_001_key UNIQUE (ballot_id, name);


--
-- Name: mbt_event_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mbt_event
    ADD CONSTRAINT mbt_event_pkey PRIMARY KEY (event_id);


--
-- Name: mbt_vote_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mbt_vote
    ADD CONSTRAINT mbt_vote_pkey PRIMARY KEY (vote_id);


--
-- Name: mbt_vote_ukey_mbt_vote_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mbt_vote
    ADD CONSTRAINT mbt_vote_ukey_mbt_vote_001_key UNIQUE (ballot_id, candidate_id, email);


--
-- Name: mcl_data_group_member_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mcl_data_group_member
    ADD CONSTRAINT mcl_data_group_member_pkey PRIMARY KEY (data_group_member_id);


--
-- Name: mcl_data_group_member_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mcl_data_group_member
    ADD CONSTRAINT mcl_data_group_member_ukey_001_key UNIQUE (data_group_id, type, key);


--
-- Name: mcl_data_group_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mcl_data_group
    ADD CONSTRAINT mcl_data_group_pkey PRIMARY KEY (data_group_id);


--
-- Name: mcl_data_group_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mcl_data_group
    ADD CONSTRAINT mcl_data_group_ukey_001_key UNIQUE (name);
...
--
-- Name: mcl_data_valid_type_type_template_id_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mcl_data_valid_type
    ADD CONSTRAINT mcl_data_valid_type_type_template_id_key UNIQUE (type, template_id);


--
-- Name: mcl_data_valid_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mcl_data_valid
    ADD CONSTRAINT mcl_data_valid_ukey_001_key UNIQUE (data_valid_type_id, name);


--
-- Name: mcl_dummy_var_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mcl_dummy_var
    ADD CONSTRAINT mcl_dummy_var_pkey PRIMARY KEY (dummy_var_id);


--
-- Name: mcl_dummy_var_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mcl_dummy_var
    ADD CONSTRAINT mcl_dummy_var_ukey_001_key UNIQUE (name);
...
--
-- Name: mcl_site_var_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mcl_site_var
    ADD CONSTRAINT mcl_site_var_pkey PRIMARY KEY (site_var_id);


--
-- Name: mcl_site_var_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mcl_site_var
    ADD CONSTRAINT mcl_site_var_ukey_001_key UNIQUE (name);
...
--
-- Name: mcl_template_type_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mcl_template_type
    ADD CONSTRAINT mcl_template_type_ukey_001_key UNIQUE (type);


--
-- Name: mcl_template_ukey_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mcl_template
    ADD CONSTRAINT mcl_template_ukey_001_key UNIQUE (template);
...
--
-- Name: mdlu_database_ukey_mdlu_database_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mdlu_database
    ADD CONSTRAINT mdlu_database_ukey_mdlu_database_001_key UNIQUE (name);


--
-- Name: mdlu_version_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mdlu_version
    ADD CONSTRAINT mdlu_version_pkey PRIMARY KEY (version_id);


--
-- Name: mdlu_version_ukey_mdlu_version_001_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mdlu_version
    ADD CONSTRAINT mdlu_version_ukey_mdlu_version_001_key UNIQUE (database_id, version);
...
--
-- Name: simple_content_type_data_nid_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY simple_content_type_data
    ADD CONSTRAINT simple_content_type_data_nid_key PRIMARY KEY (nid);
...
--
-- Name: wysiwyg_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY wysiwyg
    ADD CONSTRAINT wysiwyg_pkey PRIMARY KEY (format);


--
-- Name: wysiwyg_user_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY wysiwyg_user
    ADD CONSTRAINT wysiwyg_user_pkey PRIMARY KEY (uid, format);
...
--
-- Name: field_group_group_name_idx; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX field_group_group_name_idx ON field_group USING btree (group_name);
...
--
-- Name: gensas_project_job_log_idx_gensas_project_job_log_job_id_idx; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX gensas_project_job_log_idx_gensas_project_job_log_job_id_idx ON gensas_project_job_log USING btree (job_id);
...
--
-- Name: wysiwyg_user_uid_idx; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX wysiwyg_user_uid_idx ON wysiwyg_user USING btree (uid);
