-- psql -h <hostname> -d <database name> -U <username> -f mcl_create_table_phenotype_call.sql
--
-- Change path
--
...
-- Add UNIQUE
--
ALTER TABLE ONLY phenotype_call ADD CONSTRAINT phenotype_call_c1 UNIQUE (project_id, stock_id, cvterm_id, nd_geolocation_id);
--
-- Add FOREIGN KEY
--
